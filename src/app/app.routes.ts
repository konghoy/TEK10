...
import { RegistroProveedorComponent } from './pages/ui/forms/registro-proveedor/registro-proveedor.component';
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          {
            path: 'forms/registro-cliente',
            loadComponent: () =>
              import(
                './pages/ui/forms/registro-cliente/registro-cliente.component'
              ).then((m) => m.RegistroClienteComponent)
          },
          {
            path: 'forms/registro-proveedor',
            loadComponent: () =>
              import(
                './pages/ui/forms/registro-proveedor/registro-proveedor.component'
              ).then((m) => m.RegistroProveedorComponent)
          },
          {
            path: 'icons',
