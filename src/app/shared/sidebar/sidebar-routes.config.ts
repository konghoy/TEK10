...
export const ROUTES: RouteInfo[] = [

    {
        ...
        path: '', title: 'Contactanos', icon: 'bi bi-headset', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: []
    }, {
        path: 'dashboard/eCommerce', title: 'Registro Cliente', icon: 'bi bi-headset', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: []
    }, {
